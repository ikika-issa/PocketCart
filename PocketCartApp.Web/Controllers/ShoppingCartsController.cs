...
namespace PocketCartApp.Web.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CashierOnShift,Id")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CashierOnShift,Id")] ShoppingCart shoppingCart)
        {
